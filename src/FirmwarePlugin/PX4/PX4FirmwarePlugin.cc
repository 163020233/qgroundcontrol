    ...
    , _orbitFlightMode      (tr("Orbit"))
{
    ...
    static FlightModeList availableFlightModes = {
        ...
        { _stabilizedFlightMode , PX4CustomMode::STABILIZED        , false ,  false },
        { _acroFlightMode       , PX4CustomMode::ACRO              , false ,  false },
        { _rattitudeFlightMode  , PX4CustomMode::RATTITUDE         , false ,  false},
        { _altCtlFlightMode     , PX4CustomMode::ALTCTL            , false ,  false},
