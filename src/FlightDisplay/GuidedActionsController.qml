...
Item {
    ...
    readonly property string continueMissionMessage:            qsTr("继续当前任务")
    readonly property string resumeMissionUploadFailMessage:    qsTr("任务上传失败")
    readonly property string landMessage:                       qsTr("降落设备")
